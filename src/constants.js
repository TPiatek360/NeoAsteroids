...
export const MAX_MISSILES_CARRIED = 5;
...
export const MISSILE_PICKUP_DURATION = 10000;
...
export const SHIELD_DRAIN_BULLET = 5;
export const SHIELD_DRAIN_MISSILE = 20;
export const SHIELD_DRAIN_ASTEROID = 25;
export const SHIELD_DRAIN_SHIP_COLLISION = 25;
export const SHIELD_DRAIN_EXPLOSION = 40;
